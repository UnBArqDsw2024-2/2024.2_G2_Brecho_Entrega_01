...
<p style="text-align: justify;">
O Design Sprint possui as seguintes etapas: Unpack (Desempacotar),  Sketch (Esboçar),  Decide (Decidir) e Prototype (Prototipar).
</p>
...
| `1.7`  | 04/11/2024 | Introdução sobre Design Sprint e adição do Brainstorming na etapa de Unpack | [Marcelo Magalhães](https://github.com/marrcelo)                                                              | [Lucas Spinosa](https://github.com/LucasSpinosa)     |