...
| [Rodrigo Gontijo](https://github.com/rodrigogontijoo)  |  1. Participação na elaboração do BPMN de colocar item à venda auxiliando nas tarefas necessárias para o evento | Boa | Registro no Versionamento do Documento de BPMN, conforme [link](/docs/Base/1.3.ModelagemBPMN.md). |
